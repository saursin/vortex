...
TAPEOUT_DEFINES += +define+FPU_FPNEW
# TAPEOUT_DEFINES += +define+L1_DISABLE +define+LMEM_DISABLE
# Replace memories with compiled sram
TAPEOUT_DEFINES += +define+GPR_SRAM +define+IPDOM_SRAM +define+CACHE_DATA_STORE_SRAM +define+LMEM_SRAM
$(info =================================================================)
